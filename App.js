...
function ResourcesScreen() {
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <ScrollView style={{ flex: 1, height: screenHeight }}>
                <Card
                    style={{ borderRadius: '20', backgroundColor: '#5A4A99', top: 30, width: 400 }}>
                    <Card.Title rowContainer={{ flexDirection: 'center' }}
                                titleStyle={{ color: '#fff', width: screenWidth, fontSize: 30, textAlign: 'center' }} title="Resources"></Card.Title>
                    <Divider style={{ backgroundColor: '#fff', height: 1 }} />
                    <Card.Content>
                        <View rowContainer={{ alignItems: 'center' }}>
                            <View style={{ flexDirection: 'row', padding: 15, alignItems: 'flex-end' }}>
                                <Image style={{ height: 40, width: 40, marginLeft: 30 }}
                                       source={require('./assets/images/book.png')}
                                />
                                <Text style={{ textAlign: 'center', marginTop: 20, fontSize: 25, color: '#fff', width: '70%' }}>Career Center</Text>
                            </View>
                            <View style={{ flexDirection: 'row', padding: 15, alignItems: 'flex-end' }}>
                                <Image style={{ height: 40, width: 40, marginLeft: 30 }}
                                       source={require('./assets/images/money.png')}
                                />
                                <Text style={{ textAlign: 'center', marginTop: 20, fontSize: 25, color: '#fff', width: '70%' }}>Scholarships</Text>
                            </View>
                            <View style={{ flexDirection: 'row', padding: 15, alignItems: 'flex-end' }}>
                                <Image style={{ height: 40, width: 40, marginLeft: 30 }}
                                       source={require('./assets/images/bank.png')}
                                />
                                <Text style={{ textAlign: 'center', marginTop: 20, fontSize: 25, color: '#fff', width: '70%' }}>Financial Aid</Text>
                            </View>
                            <View style={{ flexDirection: 'row', padding: 15, alignItems: 'flex-end' }}>
                                <Image style={{ height: 40, width: 40, marginLeft: 30 }}
                                       source={require('./assets/images/handshake.png')}
                                />
                                <Text style={{ textAlign: 'center', marginTop: 20, fontSize: 25, color: '#fff', width: '70%' }}>Internships</Text>
                            </View>
                            <View style={{ flexDirection: 'row', padding: 15, alignItems: 'flex-end' }}>
                                <Image style={{ height: 40, width: 40, marginLeft: 30 }}
                                       source={require('./assets/images/people.png')}
                                />
                                <Text style={{ textAlign: 'center', marginTop: 20, fontSize: 25, color: '#fff', width: '70%' }}>Networking</Text>
                            </View>
                        </View>
                    </Card.Content>
                </Card>

                <View style={{ top: 70, width: 200, marginTop: 20, flexWrap:'nowrap',flexDirection:"row"}}>
                    <Text style={{ left: 40, width: 200, marginBottom: 0, fontSize: 20, color: '#5A4A99' }}>
                ...
                <View>
                    <Image
                        style={{ marginLeft:200, marginTop: 0, height: 200, width: 200 }}
                        source={require('./assets/images/Husky-Happy-Final.png')} />
                </View>
            </ScrollView>
        </View>
    );
